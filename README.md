...
Road v0.7 的 App Shell 与信息层级目标已批准；CP0 `fb52b55`、development-only CP1 `8019969` 与 production CP2 Shell 均已通过并形成线性 checkpoint。下一步是 CP3 Paper 工作面；Road v0.7 尚未完成产品验收，已接受的 production 基线仍是 Road v0.6。
...
Road v0.7   App Shell 与信息层级收口；CP2 production Shell 已通过，CP3 待执行
