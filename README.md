...
Phase 7.5 是独立的轻量 iOS 快速测试版，已在独立分支完成响应式界面、本机沙盒 Vault 与真机修复验证；它不是 macOS Road 的合入闸门。Road v0.3 Phase 3 folder-aware core 已完成，下一步是 Phase 4 folder/Trash/branch core operations；当前运行时可读 Paper v2/v3、写入 Paper/index v3，并能安全枚举和准确寻址一层文件夹中的 Paper。实时坐标见 [PROJECT](docs/PROJECT.md)。
...
Road v0.3   macOS Paper Library；Phase 3 完成，Phase 4 next
