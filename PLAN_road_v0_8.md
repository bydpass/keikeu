...
**当前游标：CP0 合同冻结。** 每次交付只更新下面这一行，不能用“代码已写”冒充设备验收。

| 本轮状态 | 当前修改 | 已确认 | 下一可见成果 | 待人工 |
| --- | --- | --- | --- | --- |
| 已验收 | [CP0 接口与写入责任表](docs/design/road-v0-8-host-contract.md) | 基线 `3c387c5`、关闭保护、合同检查与提前 YOLO | CP1 Apple 探针 | 设备批次 A 尚未执行 |
