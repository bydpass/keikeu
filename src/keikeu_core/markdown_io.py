"""Paper v2/v3 Markdown serialization plus the additive Paper v4 codec.
...
from keikeu_core.models import CardPageV4, Highlight, Paper, PaperV4, validate_paper_code
