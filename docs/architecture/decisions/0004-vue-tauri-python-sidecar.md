...
- Old-system support may be overstated; macOS 15.7+ is claimed only after the macOS 15.7 arm64 runner build/launch and same-artifact workstation retest pass.
