...
| Road v0.7 | CP7 Gate D passed; local checkpoint closeout in progress | CP0 is `fb52b55`; CP1 is `8019969`; CP2 is `55d45fc`; CP3 is `55b5313`; CP4 is `6f69310`; CP5 is `3259c42`; CP6 checkpoint is `e22b691`. The [CP6 report](acceptance/road-v0-7/cp6-author/report.md) records first-author acceptance. On `ui/cp7-v07-continuous-flow`, Gates A–C, two Gate D remediation rounds, complete-folder lifecycle, composition-safe query, top-layer preview, full revalidation, isolated Tauri smoke, and Figma Section `152:138` sync completed; the developer explicitly passed Gate D on 2026-08-25 with no unresolved P0/P1. The native macOS candidate window was not observed by automation and is deferred to CP8 rather than backfilled as CP7 evidence. This round authorizes the local CP7 checkpoint commit; no push, tag, closeout or release is implied. |
...
```text
accepted:  Road v0.7 CP7 continuous flow + whole-folder Trash on unchanged Paper v4 / Index v4 / protocol v2
checkpoint: CP7 local commit authorized; push/tag/closeout remain separate
next:      CP8 responsive navigation/Anchors; native macOS candidate-window observation is an explicit P1 Gate
```

See [SPEC](SPEC.md) for the current product boundary, the [Paper v4 design](design/road-v0-6-paper-v4-design.md) for unchanged grammar and protocol, and the [App Shell design](design/road-v0-7-app-shell-design.md) for the accepted v0.7 interface. Source and tests below remain the current runtime fact.
...
| Vue Paper slice | CP7 accepted continuous Paper flow, reversible single-line CSV-style Tags adapter, native Popover details, quiet text focus, whole-Paper save, save-time input lock, dirty departure, tagged repair, reconcile and soft delete | [`PaperView.vue`](../frontend/src/PaperView.vue), [`PaperV4Workbench.vue`](../frontend/src/PaperV4Workbench.vue), [`tagsCsv.js`](../frontend/src/tagsCsv.js) | [`PaperView.test.js`](../frontend/src/PaperView.test.js), [`PaperV4Workbench.test.js`](../frontend/src/PaperV4Workbench.test.js), [`tagsCsv.test.js`](../frontend/src/tagsCsv.test.js) |
| Vue Library slice | Road v0.7 compact range/list/actions, composition-safe all-page query, per-row native top-layer Paper preview, locator-checked path/folder/Trash lifecycle, partial reports and validated system handoff | [`LibraryView.vue`](../frontend/src/LibraryView.vue), [`LibraryV4Projection.vue`](../frontend/src/LibraryV4Projection.vue) | [`LibraryView.test.js`](../frontend/src/LibraryView.test.js), [`LibraryV4Projection.test.js`](../frontend/src/LibraryV4Projection.test.js) |
...
- **Authority:** [SPEC](SPEC.md) owns the current CP7 product boundary. The [Paper v4 design](design/road-v0-6-paper-v4-design.md) owns unchanged grammar/protocol; the [App Shell design](design/road-v0-7-app-shell-design.md) owns CP6 history plus the accepted CP7 matrix; the Chinese [plan](../PLAN_road_v0_7.md) owns Gate order. [RULES](RULES.md) owns implementation discipline; [AGENTS](../AGENTS.md) owns agent procedure. Runtime facts come from [`src/`](../src/) and [`tests/`](../tests/).
- **Views:** [design](design/design.html), [interaction](design/interaction.html), and [architecture](architecture/architecture.html) describe the accepted CP7 composition on unchanged Paper v4/Index v4/protocol v2. They do not prove a later checkpoint, Road closeout or release.
- **Companion:** the [interactive planbook](design/road-v0-7-planbook.html) presents CP0–CP6 history and the CP7 Gate sequence but remains non-authoritative and is not implementation or Gate evidence.
- **Evidence:** [acceptance](acceptance/README.md) links the passed Road v0.7 [CP0](acceptance/road-v0-7/cp0-contract/report.md), [CP1](acceptance/road-v0-7/cp1-grayscale/report.md), [CP2](acceptance/road-v0-7/cp2-shell/report.md), [CP3](acceptance/road-v0-7/cp3-paper/report.md), [CP4](acceptance/road-v0-7/cp4-library-vault/report.md), [CP5](acceptance/road-v0-7/cp5-integration/report.md), [CP6](acceptance/road-v0-7/cp6-author/report.md), and [CP7](acceptance/road-v0-7/cp7-continuous-flow/report.md) reports, plus earlier-Road evidence. [generated](generated/README.md) remains rebuildable observation; archive remains dated history rather than active authority.
...
Road v0.4, Road v0.5, and Road v0.6 are complete. Road v0.7 CP0–CP7 passed; CP7 adds the accepted continuous flow and narrow complete-folder lifecycle while Paper v4/Index v4/protocol v2 remain unchanged. The developer explicitly passed Gate D after the complete Core/Library remediation, full checks, isolated native UI evidence and Figma synchronization. The native macOS candidate-window observation remains a CP8 P1 Gate, not missing CP7 evidence. The CP6-authorized existing Vault was already v4; no new real-Vault operation is authorized. The CP7 local checkpoint is authorized this round; push, tag, signing, packaging, release and broader compatibility remain unperformed and unclaimed.

## History boundary

Road v0.1/v0.2 history, Road v0.3 design and acceptance, Road v0.4 planning, the Road v0.5 construction snapshot, old planning debates, frozen status pages, and the Phase 8.5 proposal live under [archive](archive/README.md). Human explanations live under [manual](manual/README.md). Neither overrides the active SPEC and RULES.
