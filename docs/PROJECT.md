...
| Road v0.6 | CP2 complete under advance YOLO | Planning approval is `9bb722a`; CP0 is `08626a9`, CP1 is `cc41eff`, and the CP2 checkpoint is branch `core/cp2-paper-v4-migration-index` HEAD. [CP2 evidence](acceptance/road-v0-6/cp2-migration-index/report.md) records frozen-v3 wiring, loss-audited migration, Index/Trash/Branch checks, interruption resume, backup verification, and v1 runtime smoke. The next Gate is development-only CP3; real Vault, push, tag, release, closeout, and CP7 remain unauthorized. |
...
Road v0.4 and Road v0.5 are complete. Road v0.6 CP2 additive migration/Index Core is complete and CP3 is next; production still uses Paper v3/protocol v1, and no protocol-v2 activation, real-Vault migration, tag, push, signing, packaging, release, or CP7 acceptance is claimed yet.
