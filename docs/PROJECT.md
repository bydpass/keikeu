...
| Road v0.8 | Plan draft recorded; not started | The developer authorized the pre-start [plan draft](../PLAN_road_v0_8.md) on 2026-08-26. Earliest CP0 start remains 2026-08-28 and still requires explicit plan/seed approval. No checkpoint, build, signing, package, distribution, remote write or release action has started; Road v0.7 supplies the accepted baseline. |
...
next:      Road v0.8 packaging + Alpha may start no earlier than 2026-08-28 under a separate approved plan
```
