...
| Road v0.7 | CP5 passed; CP6 next | CP0 is `fb52b55`; CP1 is `8019969`; CP2 is `55d45fc`; CP3 is `55b5313`; CP4 is `6f69310`. The [CP5 report](acceptance/road-v0-7/cp5-integration/report.md) records the complete Python/Vue/Rust gate plus isolated current-source Tauri normal, native dirty-confirmation, Index, repair, `commit_unknown`, restart/no-replay and clean-exit paths on `test/cp5-v07-integration`. No unresolved P0/P1 was found. Product acceptance remains unfinished; real-Vault work, push, tag, closeout, and release remain unauthorized. |
