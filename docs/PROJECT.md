...
| Road v0.7 | Complete; CP8 accepted and Road archived | CP0 `fb52b55`, CP1 `8019969`, CP2 `55d45fc`, CP3 `55b5313`, CP4 `6f69310`, CP5 `3259c42`, CP6 `e22b691`, CP7 `1e17cea`, and CP8 `2f03aee` form the checkpoint ledger. The developer explicitly accepted CP8 and declared Road v0.7 complete on 2026-08-26. The [CP8 report](acceptance/road-v0-7/cp8-responsive-navigation/report.md) separates engineering and developer QA; the [Road snapshot](archive/snapshots/road-v0-7.html) binds the final checkpoint. No real Vault operation, push, tag, signing, package, or release was performed. |
| Road v0.8 | Plan draft recorded; not started | The developer authorized the pre-start [plan draft](../PLAN_road_v0_8.md) on 2026-08-26. Earliest CP0 start remains 2026-08-28 and still requires explicit plan/seed approval. The close-guard implementation deviation recorded below must first receive a fix assignment and focused re-verification. No checkpoint, build, signing, package, distribution, remote write or release action has started; Road v0.7 supplies the accepted baseline. |
...
next:      assign and reverify the close-guard fix; then Road v0.8 CP0 may be approved no earlier than 2026-08-28 from its recorded plan draft
```
