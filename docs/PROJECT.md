...
Updated: 2026-09-05 (independent close guard accepted after developer manual review; CP0 seed remains unapproved)
...
| Road v0.8 | Revised direction documented; software CP0 seed not approved; not started | The developer approved the [plan refactor](../PLAN_road_v0_8.md) on 2026-09-04: retain Vue/Tauri, deliver iPhone core creation and mandatory Mac iCloud synchronization, then independently achieve desktop parity and retire the Python product runtime before external Alpha. [ADR-0009](architecture/decisions/0009-unified-rust-core-transition.md) records this target, not a current implementation. The independent [close-guard candidate](acceptance/close-guard-2026-09-04.md) has focused and native-window evidence; on 2026-09-05 the developer manually confirmed protection for all normal exit paths except force quit, passing the independent prerequisite; the report retains the tool-induced device-state incident; CP0 freezes contracts, CP1 proves Apple feasibility, CP2 builds Rust Core, CP3 delivers bilingual iPhone local creation, CP4 integrates iCloud, CP5 accepts the candidate. No engineering stage has started. |
