...
Updated: 2026-09-07 (Road v0.8 CP5 B10 criterion revised by developer; B14 and final candidate acceptance pending)
...
| Road v0.8 | CP5 personal candidates delivered; not product accepted | The developer rolled back the prior CP0–CP4 attempt on 2026-09-07, retaining the accepted [close guard](acceptance/close-guard-2026-09-04.md). The [revised plan](../PLAN_road_v0_8.md) and [change map](architecture/road-v0-8-changes.html) show retained Mac functionality and proposed iPhone/Rust/iCloud work. The old branches are historical attempts, not current code or acceptance evidence. The developer authorized CP0–CP5 with advance YOLO and local checkpoint commits in an isolated worktree. The [CP0 host contract](design/road-v0-8-host-contract.md) freezes the new method ownership. [CP1](acceptance/road-v0-8/cp1-apple.md) proves native probe byte round trips on Mac/iPhone, preservation and relaunch; Tauri iOS builds. [CP2](acceptance/road-v0-8/cp2-core.md) adds reviewed golden parity, pinned local file operations and read-only reconciliation; [CP3](acceptance/road-v0-8/cp3-local.md) routes the iPhone app to that Core, protects raw drafts and adds native export and bilingual creation. Device host save/relaunch passed; [CP4](acceptance/road-v0-8/cp4-cloud.md) adds explicit storage routing, coordinated cloud files and conflict preservation/recovery, with a current Mac–iPhone–Mac online content round trip. CP4 engineering checks passed under advance YOLO. [CP5 candidate delivery](acceptance/road-v0-8/cp5-candidate.md) isolates the development candidate configuration and records the mandatory test sheet; B01–B13 and B15–B16 are complete under the developer-approved B10 revision: same-code creation follows the observed provider outcome, while native conflicts are independently evidenced by B09/B11. Same-code native conflicts were not observed. Platform batch A is complete; batch B still requires B14 account/container/Drive recovery evidence, followed by final candidate acceptance. CP5 acceptance still requires all mandatory device/provider evidence. Desktop parity and Python retirement remain an independent prerequisite to external Alpha. |
...
next:      CP4 explicit cloud selection, native coordination and conflict preservation; batch B device UI remains pending
```
