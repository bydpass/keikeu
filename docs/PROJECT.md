...
| Road v0.8 | Direction recorded; not started | Earliest start is 2026-08-28. Scope direction is packaging plus Alpha release. No branch, plan, signing, package, distribution, remote write or release action has started; Road v0.7 now supplies the clean linear boundary. |
