...
| Road v0.6 | CP1 complete under advance YOLO | Planning approval is `9bb722a`; CP0 is `08626a9`, and the CP1 checkpoint is branch `core/cp1-paper-v4-core` HEAD. [CP1 evidence](acceptance/road-v0-6/cp1-core/report.md) records the additive v4 model/codec, strict failures, content fidelity, checks, and v1 runtime smoke. The next Gate is additive CP2; real Vault, push, tag, release, closeout, and CP7 remain unauthorized. |
...
Road v0.4 and Road v0.5 are complete. Road v0.6 CP1 additive Core is complete and CP2 is next; production still uses Paper v3/protocol v1, and no protocol-v2 activation, migration, real-Vault operation, tag, push, signing, packaging, release, or CP7 acceptance is claimed yet.
