...
- **Authority:** [SPEC](SPEC.md) owns the accepted Road v0.5 product boundary; the completed [Road v0.5 Planbook](../PLAN_revised.md) records checkpoint scope and execution. [RULES](RULES.md) owns engineering, interaction, data, Git, and evidence constraints; [AGENTS](../AGENTS.md) owns agent procedure. Runtime facts come from [`src/`](../src/) and [`tests/`](../tests/).
