...
| Road v0.5 | CP4 passed by advance YOLO; commit pending | CP0 is committed at `11c2149`; CP1 at `a2ff5cb`; CP2 at `30b54ac`; CP3 at `c7b9caf`. The active [Planbook](../PLAN_revised.md) records CP4 Library context retention/reset, automated evidence, two-width browser rendering, and isolated synthetic Tauri smoke under the predeclared developer YOLO boundary. |
...
Road v0.4 is complete. Road v0.5 CP1 is committed as `a2ff5cb`; CP2 as `30b54ac`; CP3 as `c7b9caf`; CP4 engineering and isolated synthetic QA passed by advance YOLO and awaits its authorized `aic` commit. Tag, archive, push, signing, distribution, and any real-Vault operation remain separate developer decisions.
