...
- [`road-v0-5/cp7-fixed-sidebars/report.md`](road-v0-5/cp7-fixed-sidebars/report.md) — advance-YOLO CP7 fixed rails, bounded scrolling, hidden scrollbar chrome, and no-overscroll evidence.
